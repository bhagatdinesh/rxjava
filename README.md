...
[What is RxJava and reactive programming?](http://www.vogella.com/tutorials/RxJava/article.html#what-is-rxjava-and-reactive-programming)
...
When using reactive programming, data streams are going to be the spine of your application. 
...
[Why doing asynchronous programming](https://www.vogella.com/tutorials/RxJava/article.html#why-doing-asynchronous-programming)
...
| **Type**      | **Description**                                              |
| ------------- | ------------------------------------------------------------ |
| Flowable<T>   | Emits 0 or n items<br/>and terminates with an success or an error event. Supports backpressure, which<br/>allows to control how fast a source emits items. |
| Observable<T> | Emits 0 or n items<br/>and terminates with an success or an error event. |
...
[Convenience methods to create observables](https://www.vogella.com/tutorials/RxJava/article.html#convenience-methods-to-create-observables)
...
[Conversion between types](https://www.vogella.com/tutorials/RxJava/article.html#conversion-between-types)
...
- AndroidSchedulers.mainThread()
  ...
  **Note**: Be careful while using Schedulers backed by unbounded thread pools like Schedulers.io(), as there always lies a risk of infinitely growing the thread pool and flooding the system with too many threads.
  ...
  It’s worth spending some time understanding the above scenario in depth. 

  Why does the Schedulers.io() Scheduler take its effect and not the other ones? 

  Normally, you would think that the Schedulers.newThread() should have taken effect as it was applied last in the chain.
